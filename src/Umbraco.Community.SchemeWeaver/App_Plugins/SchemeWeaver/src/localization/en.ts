export default {
  schemeWeaver: {
    ...
    pickerModePickedObject: 'A custom object built from the picked item',
    pickerWholeItemHint: 'The picked item renders via its own document type’s Schema.org mapping.',
    pickerPickedObjectHint: 'Map the picked item’s own properties into this Schema.org type, for this usage only. The picked item’s own mapping is not used.',
    configurePickedObject: 'Configure object',
    configurePickedObjectDisabledHint: 'Choose the picked item’s document type first',
    pickedObjectBreadcrumb: 'Picked item · {0}',
